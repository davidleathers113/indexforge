...
def test_source_metadata_mapping(mock_processor, valid_document):
    ...
    source_doc = {
        "content": {"full_text": "Test content", "summary": "Test summary", "title": "Test title"},
        "metadata": {
            "source_type": "word",
            "author": "John Doe",
...
def test_nested_field_mapping(mock_processor, valid_document):
    ...
    source_doc = {
        "content": {
            "full_text": "Test content",
            "metadata": {"formatting": {"font": "Arial", "size": 12}},
        },
        "metadata": {
            "source_type": "word",
            "document_info": {"created_by": "John Doe", "department": "Engineering"},
        },
    }
    mock_processor.process.return_value = source_doc
    processor = BaseProcessor()
