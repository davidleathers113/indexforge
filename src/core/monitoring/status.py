...
class StatusManager:
    ...
    def get_processing_summary(
        self, lineage_data: Dict[str, DocumentLineage], time_window: Optional[timedelta] = None
    ) -> Dict[str, Any]:
    ...
    def _get_latest_step(self, lineage: DocumentLineage) -> Optional[ProcessingStep]:
