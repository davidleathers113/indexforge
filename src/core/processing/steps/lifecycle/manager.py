...
class ProcessingStepManager:
    ...
    def add_step(
        ...
        try:
            ...
            raise RuntimeError(f"Failed to add processing step: {str(e)}") from e
    ...
    def get_steps(
        ...
        try:
            ...
            raise RuntimeError(f"Failed to get processing steps: {str(e)}") from e
    ...
    def get_recent_errors(
        ...
        try:
            ...
            raise RuntimeError(f"Failed to get recent errors: {str(e)}") from e
